...
- app_docs/feature-d8b2ff70-conversational-followups.md
  - Conditions:
    - When working with conversational context or follow-up queries
    - When modifying the QueryRequest model or LLM prompt construction
    - When troubleshooting the "Continuing from" context indicator or "Clear context" button
    - When implementing multi-turn or context-aware SQL generation
