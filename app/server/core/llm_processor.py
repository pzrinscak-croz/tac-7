...
def format_previous_context(previous_query: str = None, previous_sql: str = None) -> str:
    """
    Build a delimited previous-turn context block for conversational follow-ups.
    Returns an empty string when either value is falsy (no usable context).
    """
...
def generate_sql_with_openai(query_text: str, schema_info: Dict[str, Any], previous_query: str = None, previous_sql: str = None) -> str:
    """
    ...
    try:
        ...
        # Optional conversational follow-up context
...
def generate_sql_with_anthropic(query_text: str, schema_info: Dict[str, Any], previous_query: str = None, previous_sql: str = None) -> str:
    """
